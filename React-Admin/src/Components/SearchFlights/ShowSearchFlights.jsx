...
const ShowSearchFlights = ({ searchFlights,permission }) => {
                ...
                {searchFlights.map((searchFlights) => (
                  <tr key={searchFlights.id_flights}>
                    ...
                    <td className="align-middle">
                      {searchFlights.flight_number}
                    </td>
                    <td className="align-middle">
                      {searchFlights.business_class_seat}
                    </td>
                    <td className="align-middle">
                      {searchFlights.economy_class_seat}
                    </td>
                    <td className="align-middle">
                      {searchFlights.first_class_seat}
                    </td>
                    <td className="align-middle">
                      {searchFlights.business_class_price}
                    </td>
                    <td className="align-middle">
                      {searchFlights.economy_class_price}
                    </td>
                    <td className="align-middle">
                      {searchFlights.first_class_price}
                    </td>
                    <td className="align-middle">
                      <Modal
